function figName = genPlots(otData, yData, idx)
...
if nargin > 2; plot(idx.CV,eCV(:,1),'bx','MarkerSize',10); end
...
if nargin > 2; plot(idx.CV,eCV(:,2),'bx','MarkerSize',10); end
...
if nargin > 2; plot(idx.CV,eCV(:,3),'bx','MarkerSize',10); end
if nargin > 2
