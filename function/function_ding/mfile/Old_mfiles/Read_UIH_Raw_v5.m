function [rawdata,phasecor,feed_back,noise_scan, SO0, SO1, SO2, SO3] = Read_UIH_Raw_v5(filename)
...
ACQFlag = 0;
NoiseScanIndex = 0;
DataFormat = 1;%1:DHL.m_ucVersion=1;2:DHL.m_ucVersion=2
TempNum = 0;
...
maxUD0 = 0; maxUD0 = 0; maxUD0 = 0; maxUD0 = 0; maxUD0 = 0;
while(ACQFlag ~= 1)
    ...
    if(~DHLMask.DHL_NOISE_SCAN & ~DHLMask.DHL_FEEDBACK)
        ...
        maxUD1 = max(maxUD0, DHL.m_ushUser(2));
        maxUD2 = max(maxUD0, DHL.m_ushUser(3));
        maxUD3 = max(maxUD0, DHL.m_ushUser(4));
        maxUD4 = max(maxUD0, DHL.m_ushUser(5));
    end
