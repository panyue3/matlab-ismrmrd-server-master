% function [tt_out,ang_tt_out, qp_out,ang_qp_out,sl_out,ang_sl_out,hex_out,hex_ang] = find_ang_corr_ang(a2,a2f,p2,p2f,a4,a4f,a5,a5f,p5,p5f,k0)
% f = 80 Hz k = 20; f=90Hz, k0 = 22;
function [tt_out,ang_tt_out,qp_out,ang_qp_out,sl_out,ang_sl_out, hex_out,ang_hex_out] = find_ang_corr_ang(a2,a2f,p2,p2f,a4,a4f,a5,a5f,p5,p5f,k0)
...
for A4=a4:100:a4f
    ...
    tt_out(phi_2,phi_5) = max_tt(1);      ang_tt_out(phi_2,phi_5) = ang1(N(1)) ;
	sl_out(phi_2,phi_5) = max_sl(1);		ang_sl_out(phi_2,phi_5) = ang_sl(N_sl(1)) ;
	qp_out(phi_2,phi_5) = max_qp(1);		ang_qp_out(phi_2,phi_5) = ang_qp(N_qp(1)) ;
    hex_out(phi_2,phi_5) = max_hex(1);    ang_hex_out(phi_2,phi_5) = ang2(N_hex(1));
        %hex,ang2
    end
end ;   end ;   end ;   end
