...
t0 = dicomread( sprintf('%s%s',pname,fnames(n_j(1)).name) );
s = size(t0);
...
%s = size(a_0);
clear temp; clear h, clear t0; clear s, clear fname; clear l_name; clear i, clear j; clear n_j; clear pname; clear fnames
