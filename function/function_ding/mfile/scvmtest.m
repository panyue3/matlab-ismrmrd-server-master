function [H, p_value, W2]=scvmtest(x, F)
...
alpha = 0.05; % Ding 2008_09_08 I give it artificially
N=length(x);
...
I=[1:N];
S=I/N; %order statistics % Ding 2008_09_08 Do you actually use it?

%Build the Null Hypothesis c.d.f F(x), the normal distribution with zero mean and unit variance.
x=sort(x);
%F=0.5*erfc(-x/sqrt(2)); %normal cumulative distribution % Ding 2008_09_08

% cdfplot(x); % Ding 2008_09_08
% hold on;    % Ding 2008_09_08
% plot(x,F);  % Ding 2008_09_08

%Calculate the Smirnov-Cramer-Von Mises metric
W2=(1/12/N+sum((F-(2*I-1)/2/N).^2))/N; %see reference

%Decision
H=(W2<=CV); % Ding 2008_09_08 Not realiable anymore
p_value = 0.5; % Ding 2008_09_08 do not know how to do it yet
