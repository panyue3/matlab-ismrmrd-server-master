...
function [Cutoff2, Cutoff4] = Velicer_Map(r)
% Velicer's MAP test: [Cutoff2, Cutoff4] = Velicer_Map(r)
% r:        Covariance Matrix
% Cutoff2:  Cutoff use square
% Cutoff4:  Cutoff use ^4
...
% find(fm(:,2) == minfm)
% find(fm4(:,2) == minfm4)
T_Cut2 = nvars - find(fm(:,2) == minfm);
T_Cut4 = nvars - find(fm4(:,2) == minfm4); 
Cutoff2 = T_Cut2(1); 
Cutoff4 = T_Cut4(1); 
