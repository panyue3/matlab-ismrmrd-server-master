...
% array and the percentage eign images you want to keep [a_r,V,D] = my_KL(a,r), a is
...
if length(s) ~=3,
    ...
    if r>1|r<=0
        ...
        A = b*conj(b'); clear b; A = (A + conj(A'))/2;
%        A = b*(b'); clear b;
        %clock,
        ...
        for i=N-round(N*r)+1:N % the rest will not be used any way.
        ...
        for i=1:N
            ...
            %a_r(:,:,i) = temp.*(temp>0);
            a_r(:,:,i) = temp; % without fixing the negative value problem.
        end
