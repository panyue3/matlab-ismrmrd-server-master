...
function [b0,y0]=background_mov_80_60(fname,m,n,method)

fid = fopen(fname,'r');  
a00=fread(fid,[80,60],'uchar');  
a00 = double(a00);
a(1:80,1:60) = a00;  i00=0;      
while prod(size(a00))==4800,            
    a00=fread(fid,[80,60],'uchar');            
    if prod(size(a00))==4800,  i00=i00 + 1;    a=a + a00;    end; 
...
ay = sum(a>1,2);
for i=1:17, ty(i) = sum(ay(i:i+63)); end 
