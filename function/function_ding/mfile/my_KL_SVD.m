...
% array and the percentage eign images you want to keep a_r = my_KL_SVD(a,r), a is
...
% This is a SVD version of the code. It is not momery efficient, but will
% run faster since SVD has fast algorithm.

function a_r = my_KL_SVD(a,r);
