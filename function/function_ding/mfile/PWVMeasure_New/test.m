clear all;
close all;
load baseline_new_data.mat;
%load may7DogPheny.mat;

vels_at_a_dist = PWVData.velocity_matrix(:,79);
...
figure;
plot(useful_vels_ind,useful_vels);
figure;
plot(max_jump_indices_in_original_plot, vels_at_a_dist(max_jump_indices_in_original_plot));
